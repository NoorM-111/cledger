  ...
  return (
    <>
      ...
      <section aria-label="About Cledger bookkeeping services" style={{
        ...
        <p style={{ fontFamily: "'Hanken Grotesk', sans-serif", color: '#5F5A50', lineHeight: 1.8, marginBottom: '1rem' }}>
        ...
        <p style={{ fontFamily: "'Hanken Grotesk', sans-serif", color: '#5F5A50', lineHeight: 1.8, marginBottom: '2rem' }}>
        ...
        <p style={{ fontFamily: "'Hanken Grotesk', sans-serif", color: '#5F5A50', lineHeight: 1.8, marginBottom: '1rem' }}>
          ...
          HMRC submission on your behalf — helping you meet deadlines and avoid unexpected penalties.
        </p>
        <p style={{ fontFamily: "'Hanken Grotesk', sans-serif", color: '#5F5A50', lineHeight: 1.8, marginBottom: '2rem' }}>
        ...
        <p style={{ fontFamily: "'Hanken Grotesk', sans-serif", color: '#5F5A50', lineHeight: 1.8, marginBottom: '0' }}>
