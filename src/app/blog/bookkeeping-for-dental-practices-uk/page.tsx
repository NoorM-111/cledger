...
export const metadata = {
  title: 'Bookkeeping for Dental Practices UK (2026 Guide)',
  description: 'The 2026 guide to UK dental practice bookkeeping: mixed NHS and private income, associate payments, VAT exemptions and CQC compliance.',
  openGraph: {
    title: 'Bookkeeping for Dental Practices UK (2026 Guide)',
