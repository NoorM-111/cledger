...
const sectors = [
  ...
  { n: '02', icon: <ScanFace    size={20} strokeWidth={1.5} />, label: 'Dental Practices',          href: '/accountant-for-dental-practices-uk' },
  { n: '03', icon: <HardHat     size={20} strokeWidth={1.5} />, label: 'Construction & Trades'    },
  { n: '04', icon: <Home        size={20} strokeWidth={1.5} />, label: 'Property & Landlords',      href: '/accountant-for-landlords-uk' },
  ...
  { n: '07', icon: <ShoppingCart size={20} strokeWidth={1.5} />, label: 'Retail & eCommerce',       href: '/accountant-for-ecommerce-uk' },
