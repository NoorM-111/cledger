...
export default function VatCalculator() {
    ...
    return (
      <div style={{ marginBottom: '1.5rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
          <h3 style={{ fontFamily: '"DM Serif Display", Georgia, serif', fontSize: '1.05rem', color: C.white }}>
            {title}
          </h3>
          <button
  ...
  return (
    <div>
      {/* Scheme selector */}
      <div style={{ marginBottom: '1.5rem' }}>
        <label style={{ fontFamily: 'Sora, sans-serif', fontSize: '13px', color: C.muted, display: 'block', marginBottom: '6px' }}>
          VAT scheme
        </label>
          ...
          {([
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '6px',
                cursor: 'pointer',
                border: scheme === s.id ? '1px solid #C9A84C' : '1px solid rgba(201,168,76,0.2)',
                background: scheme === s.id ? 'rgba(201,168,76,0.15)' : C.card,
      ...
      {scheme === 'flatrate' && (
        <div style={{ marginBottom: '1.5rem', maxWidth: '240px' }}>
          <label style={{ fontFamily: 'Sora, sans-serif', fontSize: '13px', color: C.muted, display: 'block', marginBottom: '4px' }}>
          ...
          />
          <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '11px', color: C.muted, marginTop: '4px' }}>
      ...
      <div style={{
        ...
        {scheme !== 'flatrate' && (
          <div style={{ background: C.card2, border: '1px solid rgba(201,168,76,0.15)', borderRadius: '12px', padding: '1.25rem' }}>
            <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '12px', color: C.muted, marginBottom: '0.25rem' }}>Output VAT on sales</p>
            <p style={{ fontFamily: '"DM Serif Display", Georgia, serif', fontSize: '1.5rem', color: C.white, lineHeight: 1.1 }}>{fmt(results.outputVAT)}</p>
          </div>
        )}
        {scheme !== 'flatrate' && (
          <div style={{ background: C.card2, border: '1px solid rgba(201,168,76,0.15)', borderRadius: '12px', padding: '1.25rem' }}>
            <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '12px', color: C.muted, marginBottom: '0.25rem' }}>Input VAT reclaimable</p>
            <p style={{ fontFamily: '"DM Serif Display", Georgia, serif', fontSize: '1.5rem', color: C.white, lineHeight: 1.1 }}>{fmt(results.inputVAT)}</p>
          </div>
        )}
        {scheme === 'flatrate' && (
          <div style={{ background: C.card2, border: '1px solid rgba(201,168,76,0.15)', borderRadius: '12px', padding: '1.25rem' }}>
            <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '12px', color: C.muted, marginBottom: '0.25rem' }}>Gross turnover (inc. VAT)</p>
            <p style={{ fontFamily: '"DM Serif Display", Georgia, serif', fontSize: '1.5rem', color: C.white, lineHeight: 1.1 }}>{fmt(results.grossTurnover)}</p>
          </div>
        )}
        <div style={{
          background: C.card2,
          ...
          <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '12px', color: C.muted, marginBottom: '0.25rem' }}>{vatLabel}</p>
          <p style={{ fontFamily: '"DM Serif Display", Georgia, serif', fontSize: '1.75rem', color: vatDueColor, lineHeight: 1.1 }}>{vatDisplay}</p>
        </div>
      </div>
      ...
      {scheme === 'flatrate' && (
        <div style={{
          ...
          <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '13px', color: C.muted, lineHeight: 1.6 }}>
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        <h3 style={{ fontFamily: '"DM Serif Display", Georgia, serif', fontSize: '1.05rem', color: C.white, marginBottom: '0.75rem' }}>
          Sales breakdown
        </h3>
      ...
      <div style={{
        ...
        <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '13px', color: C.muted, lineHeight: 1.7, marginBottom: '0.5rem' }}>
        ...
        <p style={{ fontFamily: 'Sora, sans-serif', fontSize: '12px', color: C.muted, lineHeight: 1.6, margin: 0 }}>
